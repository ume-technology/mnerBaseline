...
with open('./tagdata2ner_20230301/raw_data/stack.json', 'r', encoding='utf-8') as f:
    stack_examples = json.load(f)
    for i in stack_examples:
        i['pseudo'] = 0

    tmpRst = stack_examples[600:800]
...
with open('tagdata2ner_20230301/raw_data/train.json', 'w', encoding='utf-8') as fp:
    fp.write(json.dumps(train, ensure_ascii=False))
with open('tagdata2ner_20230301/raw_data/dev.json', 'w', encoding='utf-8') as fp:
