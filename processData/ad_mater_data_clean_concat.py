...
"""
@Author:UmeAI
@File:ad_mater_data_clean_concat.py
@Time:2022/12/13 18:40
@Read: 这个文件也是清洗素材数据；但是是和商品等信息结合起来的情况
"""
import re
import pickle
...
with open('./datagiikin/bigfiles/readdatafrommatterial.pick', 'rb') as f:
...
# with open('./datagiikin/bigfiles/ad_mater_data_clean_concat.pick', 'wb') as f:
#     pickle.dump(matgoodsinfo, f)
