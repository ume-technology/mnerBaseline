...
from nercode.src.processor import ENTITY_TYPES
...
# import numpy as np
# from collections import defaultdict
# from ..src.processor import ENTITY_TYPES
